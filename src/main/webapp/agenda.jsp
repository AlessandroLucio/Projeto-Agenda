...
<body>
	<div class="container cont-agenda">
		...
		<div class="table-responsive">
			<table
				class="table table-striped table-bordered table-hover align-text-center">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="select?idcon=<%=lista.get(i).getIdcon()%>" class="btn btn-primary btn-sm">Editar</a>
